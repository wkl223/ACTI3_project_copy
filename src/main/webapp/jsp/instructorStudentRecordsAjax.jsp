...
<c:forEach items="${data.resultsTables}" var="resultsTable" varStatus="fbIndex">
  <tisr:resultsTable responses="${resultsTable.receivedResponses}" studentName="${resultsTable.studentName}"
                     fbIndex="${fbIndex.index}"
                     panelHeadingToOrFrom="To" panelEntryToOrFrom="From" viewType="GRQ" forOrBy="for"/>
  <tisr:resultsTable responses="${resultsTable.givenResponses}" studentName="${resultsTable.studentName}"
                     fbIndex="${fbIndex.index}"
