...
<c:set var="shouldShowFilterPanelAndExpandCollapseButton"
       value="${not (noResponses and data.allSectionsSelected and showAll)}"/>
...
<c:if test="${noResponses and showAll}">
  <div class="bold color_red align-center">There are no responses for this feedback session yet or you do not have
    access to the responses collected so far.
  </div>
</c:if>
