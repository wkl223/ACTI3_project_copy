...
<c:if test="${data.allSectionsSelected}">
  <ti:remindParticularStudentsModal
      remindParticularStudentsLink="${data.noResponsePanel.remindParticularStudentsLink}"/>
  <div class="panel panel-default">
    ...
    <div class="panel-heading ${data.largeNumberOfResponses ? 'ajax-response-submit' : 'ajax-response-auto'}">
      ...
      <div class="display-icon pull-right">
        ...
        <span
            class="glyphicon ${!isLoadingStructure ? 'glyphicon-chevron-up' : 'glyphicon-chevron-down'} pull-right"></span>
      </div>
