  ...
  <div class="container">
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-teampeerevaluations.png"
             alt="Team peer evaluations">
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-flexiblefeedbackpaths.png"
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-powerfullvisibilitycontrol.png"
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-reportsandstatistics.png"
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-finegrainaccesscontrol.png"
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-differentquestiontypes.png"
             alt="Different question types">
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
            Essay questions, MCQ questions, Multiple select questions, Numeric scale questions, 'Distribute a fixed
            number of points among options' questions, questions measuring contribution in team projects, and more
            choices coming soon...
            <br><br>
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-reusepastquestions.png"
             alt="Reuse past questions">
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-nosignuprequired.png"
        ...
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
            ...
            without having to login or signup.
            <br><br>
            If they login to TEAMMATES using their Google accounts (optional), they can access all TEAMMATES courses in
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
            ...
            For example, you can give a comment to a student that the receiving student can see while other students in
            the course can only see the comment text but cannot see the recipient name.
          </div>
        </div>
        <img class="img-responsive features-page-img" src="images/raised-edge.png">
      </div>
      ...
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
            ...
            <br><br>
            You can access all data about a student in one page, just by typing a part of the student’s name in our
            search box. In a single page you can see,<br>
    ...
    <section class="row">
      <div class="col-xs-12 col-sm-8 col-sm-offset-2">
        ...
        <img class="img-responsive features-page-img" src="images/feature-supportforbigcourses.png"
        ...
        <div class="col-xs-9 col-sm-9">
          <div class="features-page-text">
            ...
            into sections of no more than 100 students.
    ...
    <div class="features-page-text-bottom">
      <p class="col-xs-12 col-sm-8 col-sm-offset-2">
        For more details about these features, visit the <a href="instructorHelp.jsp" target="_blank"
                                                            rel="noopener noreferrer">Instructor Help</a> page or <a
          href="contact.jsp">email us</a>.
      </p>
    </div>
  </div>
</t:staticPage>
