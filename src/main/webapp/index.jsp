...
<t:staticPage jsIncludes="${jsIncludes}" currentPage="index">
  ...
  <main>
    ...
    <div class="row">
      <div
          class="margin-bottom-10px col-xs-10 col-sm-5 col-xs-offset-1 col-md-4 col-md-offset-2 col-lg-3 col-lg-offset-3">
        <a class="btn btn-default btn-block" href="https://www.youtube.com/embed/mDtfmNmRwBM?autoplay=1&rel=0"
           target="_blank">
  ...
  <div class="Column">
    ...
    <img class="center-block img-responsive" alt="TEAMMATES - Designed for simplicity, flexibility, power"
  ...
  <div class="Column">
    ...
    <img class="center-block img-responsive" alt="TEAMMATES - Powered by Google Infrastructure"
  ...
  <div class="Column">
    ...
    <img class="center-block img-responsive" alt="TEAMMATES - Growing global community"
  ...
  <div class="row">
    <div class="Column">
      ...
      <img class="center-block img-responsive" alt="TEAMMATES - Well received by Academic community"
