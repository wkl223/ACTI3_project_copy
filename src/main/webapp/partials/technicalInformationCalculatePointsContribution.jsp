  ...
  <ul>
    <li>
      ...
      <div class="helpSectionContent">
        ...
        <br>(b) In your opinion, if your teammates are doing the project by themselves without you, how do they compare
        against each other in terms of contribution?
        <br>
        <br>In the calculation, we do not allow (a) to affect (b). We use (b) to calculate the average perceived
    ...
    <li>
      ...
      <div class="helpSectionContent">
        <ol type="1">
          <li>
            ...
            <div class="helpSectionContent">
              ...
              <div class="bs-example">
                entered values: <code>90</code> [self], <code>110</code>, <code>130</code>, <code>N/A</code> (total =
                <code>330</code>)
          ...
          <li>
            <span
                class="text-bold">Calculate <code>peerContributionRatio</code> values by removing self-rating bias</span>
            <div class="helpSectionContent">
              ...
              This answers the question (b) above. In the example above, the student thinks his teammates contribution
              ratio is <code>92:108</code> and is unsure of the third teammate.
              <br>
              <br>
            </div>
          </li>
          <li>
            ...
            <div class="helpSectionContent">
              Next, we calculate <code>averagePerceivedContributionRatio</code> among team members, independent of (a).
              ...
              <ol type="i">
                ...
                <li>
                  ...
                  <div class="helpSectionContent">
                    ...
                    <code>
                      ...
                      <br>normalizationFactor = 100 * (number of students with averagePerceived values)/(sum of
                      averagePerceived)
                    </code>
                    <br>
                    <br>This is the relative work distribution among team members based on unbiased opinions of team
                    members.
                    <br>
                    <br>
                  </div>
                ...
                <li>
                  ...
                  <div class="helpSectionContent">
                    Since we normalized the averages (in previous step), we also normalize the value that were averaged
                    in the first place. This is such that average and averaged tallies with each other.
                    <br>
                    <br>
          ...
          <li>
            ...
            <div class="helpSectionContent">
              For each student, denormalize <code>normalizedAveragePerceived</code>. We scale back to match the total of
              original
              input by student. That way, student can compare his input (i.e., his opinion of the team’s work
              distribution)
              with the team’s opinion. In the example used above, we should use 330/300 as the denormalizing factor for
              that student.
              The result could be something like this:
              <br>
              <br>
              <div class="bs-example">
                student’s opinion: <code>90</code> [self], <code>110</code>, <code>130</code>, <code>N/A</code> (total =
                <code>330</code>)
                <br>team’s opinion : <code>95</code>, <code>105</code>, <code>125</code>, <code>115</code> (total =
                <code>440</code>)
              </div>
      ...
      <ul>
        <li>
          for claimed contribution, show: same as what the student entered initially (otherwise, the student will be
          confused as to how the value got changed)
        </li>
        <li>
      ...
      <ul>
        <li>
          Scenario 1: If students give 0 points to each other, then everyone should receive Equal Share and difference
          should be 0.
        </li>
        <li>
          Scenario 2: If students are not sure or do not submit the evaluation, then Perceived/Claimed for Instructor
          should be shown as N/A instead of Equal Share. In this case, difference too should be shown as N/A.
        </li>
      </ul>
    </li>
  </ul>
