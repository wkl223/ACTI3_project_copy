...
<t:staticPage jsIncludes="${jsIncludes}" currentPage="about">
  <div class="container">
    <section class="row">
      ...
      <ul>
        <li>
          <a href="http://www.comp.nus.edu.sg/" target="_blank" rel="noopener noreferrer"><b>School of Computing,
            National University of Singapore (NUS)</b></a>, for providing us with the infrastructure support to run the
          project.
        </li>
        <li>
          <a href="http://www.cdtl.nus.edu.sg/" target="_blank" rel="noopener noreferrer"><b>Centre for Development of
            Teaching and Learning (CDTL)</b></a> of NUS, for supporting us with several Teaching Enhancement Grants over
          the years.
        </li>
        <li>
        ...
        <li>
          <b>Google Summer of Code</b> Program, for including TEAMMATES as a mentor organization in GSoC2014, GSoC2015,
          GSoC2016, GSoC2017 and GSoC2018 editions.
        </li>
        <li>
          <b>Facebook Open Academy</b> Program, for including TEAMMATES as a mentor organization in FBOA 2016.
        </li>
        <li>
          <b>Jet Brains</b>, for the <a href="https://www.jetbrains.com/idea/" target="_blank"
                                        rel="noopener noreferrer">Intellij IDEA</a> licences.
        </li>
        <li>
          <b>YourKit LLC</b>, for providing us with free licenses for the <a
            href="https://www.yourkit.com/java/profiler/" target="_blank" rel="noopener noreferrer">YourKit Java
          Profiler</a>
