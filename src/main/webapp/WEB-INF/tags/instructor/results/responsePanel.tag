...
<%@ attribute name="responsePanel" type="teammates.ui.template.InstructorFeedbackResultsResponsePanel"
              required="true" %>

<div class="panel panel-info">
  <!--Note: When an element has class text-preserve-space, do not insert and HTML spaces-->
  <div class="panel-heading">
    Question ${responsePanel.question.questionNumber}: <span
      class="text-preserve-space">${responsePanel.questionText}${responsePanel.additionalInfoText}</span>
  </div>
  <div class="panel-body">
    ...
    <c:if test="${responsePanel.question.questionDetails.instructorCommentsOnResponsesAllowed}">
      <ul class="list-group"
          id="responseCommentTable-${responsePanel.sectionId}-${responsePanel.recipientIndex}-${responsePanel.giverIndex}-${responsePanel.qnIndex}"
