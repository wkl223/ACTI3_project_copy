...
<div class="modal fade" id="commentModal-${responseRecipientIndex}-${responseGiverIndex}-${questionIndex}"
     role="dialog">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close commentModalClose" data-dismiss="modal"
                data-recipientindex="${responseRecipientIndex}"
      ...
      <div class="modal-body">
        <ul class="list-group"
            id="responseCommentTable-${responseRecipientIndex}-${responseGiverIndex}-${questionIndex}"
          ...
          <shared:feedbackResponseCommentAdd frc="${responseRow.addCommentButton}"
                                             firstIndex="${responseRecipientIndex}"
                                             secondIndex="${responseGiverIndex}" thirdIndex="${questionIndex}"
                                             isOnQuestionsPage="true"/>
        </ul>
      </div>
