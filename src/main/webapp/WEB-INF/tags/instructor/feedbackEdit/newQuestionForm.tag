...
<form id="form_editquestion-${NEW_QUESTION}" class="form-horizontal form_question tally-checkboxes" role="form"
      method="post"
  ...
  <input type="hidden" id="<%= Const.ParamsNames.FEEDBACK_QUESTION_TYPE %>"
