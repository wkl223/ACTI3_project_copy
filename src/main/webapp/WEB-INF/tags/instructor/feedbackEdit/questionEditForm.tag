...
${ fqForm.questionHasResponses ? 'editStatus="hasResponses"' : '' }>
      ...
      <div class="row">
        <div class="col-sm-7">
          <span>
            <strong>Question
              <span
                  id="<%= Const.ParamsNames.FEEDBACK_QUESTION_NUMBER_STATIC %>-${fqForm.questionIndex}">${fqForm.questionIndex}:</span>
            </strong>
  ...
  <input type="hidden" name="<%= Const.ParamsNames.FEEDBACK_QUESTION_EDITTYPE %>"
         id="<%= Const.ParamsNames.FEEDBACK_QUESTION_EDITTYPE %>-${fqForm.questionIndex}" value="edit">
