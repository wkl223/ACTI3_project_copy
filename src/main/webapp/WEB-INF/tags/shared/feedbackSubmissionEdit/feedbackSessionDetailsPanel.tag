...
<%@ tag description=".jsp - Displays feedback session details" pageEncoding="UTF-8" %>
<%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
<%@ attribute name="feedbackSession" type="teammates.common.datatransfer.attributes.FeedbackSessionAttributes"
              required="true" %>
    ...
    <div class="form-horizontal">
      <div class="panel-heading">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <p class="form-control-static"
               data-date-stamp="${feedbackSession.startTimeInIso8601UtcFormat}">${feedbackSession.startTimeString}</p>
          </div>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <p class="form-control-static" id="end-time"
               data-date-stamp="${feedbackSession.endTimeInIso8601UtcFormat}">${feedbackSession.endTimeString}</p>
          </div>
        </div>
