...
<form action="<%= Const.ActionURIs.ERROR_FEEDBACK_SUBMIT %>" method="post" id="error-feedback-form">
  <div class="form-group">
    ...
    <br><em>Note: This is the TEAMMATES support email. It has been pre-filled for your convenience and is not
    editable. </em>
    <input type="email" value="<%= Config.SUPPORT_EMAIL %>" id="error-feedback-email-composer-recipient-email"
           class="form-control" name="<%= Const.ParamsNames.ERROR_FEEDBACK_EMAIL_RECEIVER_ADDRESS %>" readonly="">
  </div>
  <div class="form-group">
    ...
    <input type="text" value="<%= Const.ERROR_FEEDBACK_EMAIL_SUBJECT %>" id="error-feedback-email-composer-subject"
           name="<%= Const.ParamsNames.ERROR_FEEDBACK_EMAIL_SUBJECT %>" class="form-control">
  </div>
  <div class="form-group">
    <label for="error-feedback-email-composer-content">Content:</label>
    <textarea id="error-feedback-email-composer-content" name="<%= Const.ParamsNames.ERROR_FEEDBACK_EMAIL_CONTENT %>"
              class="form-control" placeholder="Tell us the steps you took that led you to this error page"></textarea>
  </div>
  ...
  <input type="hidden" name="<%= Const.ParamsNames.ERROR_FEEDBACK_URL_REQUESTED %>"
         value="${param.errorfeedbackrequestedurl}">
</form>
