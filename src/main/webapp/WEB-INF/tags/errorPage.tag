  ...
  <div class="row">
    <div class="col-md-12">
      ...
      <ul>
        ...
        <li>
          You loaded an outdated page unintentionally. e.g. some browsers auto-load the pages that were loaded in the
          previous browsing session.
        </li>
      </ul>
      <p>
        However, if you keep seeing this page on multiple failed attempts when trying to perform some action in
        TEAMMATES, please help us troubleshoot the problem by providing us some additional details using the form below.
      </p>
    </div>
  </div>
